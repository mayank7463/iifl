    ...
    <div className='container-margin'>
        ...
        <div className='grid lg:grid-cols-4 sm:grid-cols-1 text-4xl gap-16'>
           <div>
               ...
               <ul className='text-3xl'>
                ...
                through skill
                development</li>
                <li>Bring education closer
                to marginalised girls</li>
                <li>Enhances teacher
                capabilities and
                introduce innovative
                learning methods in
                underprivileged areas</li>
               </ul>
           </div>
           <div>
               ...
               <ul className='text-3xl'>
                ...
                <li>Provide comprehensive
                    medical services in
                    underserved regions</li>
                <li>Making affordable
                    healthcare accessible
                    to all</li>
                <li>Support the nutritional
                    and health needs of
           ...
           <div>
               ...
               <ul className='text-3xl'>
                <li>Promote sustainable
                    ...
                    practices</li>
                <li>Involving communities
                    in waste management
                    and sustainable housing
                    projects</li>
                <li>Improve living conditions
                    and encourage longterm
           ...
           <div>
               ...
               <ul className='text-3xl'>
                <li>Empower local artisans
                    and marginalized
                    communities</li>
                <li>Preserve cultural
                    heritage, and create
                    sustainable livelihoods</li>
                <li>Economic independence
        ...
        <div className='grid lg:grid-cols-2 sm:grid-cols-1 gap-8 py-16'>
            <div>
                ...
                with three meals daily, comprising two hot meals
                and one nutritious meal, with additional provisions
                for undernourished children. Regular health
                check-ups and vaccinations are also conducted to
                ensure their well-being.</p>
        ...
        <div className='grid lg:grid-cols-2 sm:grid-cols-1 gap-8 py-16'>
            ...
            <div>
                ...
                <p className='text-3xl'>We have established 10 community-based learning
                    ...
                    special coaching to excel in academics, provide
                    nutritious meals twice a day, and engage children
                    in extracurricular activities. Additionally, a mini
                    library with a collection of 100 books is set up to
                    improve reading and comprehension skills. Special
                    sessions on value education cover themes such as
                    self-awareness, responsibility, ethics, and morals.</p>
        ...
        <div className='grid lg:grid-cols-3 sm:grid-cols-1 gap-8'>
            <div>
                ...
                <p className='text-3xl pt-16'>To create a conducive learning environment for the children
                    ...
                    for those eager to excel but facing financial constraints.
                    These workshops include programs on health and hygiene
                    for women, behavioural change for men, and safety at
                    construction sites, aiming to improve health practices,
                    promote positive behaviour, and enhance safety awareness.</p>
                <div className='flex flex-col mt-16'>
                    <div>
            ...
            <div>
                ...
                <div>
                    ...
                    i n c l u d i n g
                    d ev e lo p e rs ,
                    ministries, regulators, development
                    finance institutions (DFIs), architects,
                    enthusiasts, and peers.</p>
                </div>
            </div>
            <div>
        ...
        <div className='grid lg:grid-cols-2 sm:grid-cols-1 gap-8 mt-16 mb-16'>
             <div>
                ...
                through custom-designed TLM Kits and expert training,
        ...
        <div className='grid lg:grid-cols-2 sm:grid-cols-1 gap-8 mt-16 mb-16'>
             <div>
                ...
                <p className='text-3xl pt-16'>An in-patient ward has been developed in Thane and Palghar
                    ...
                    cancer radiation therapy, comprehensive eye care, and other multispecialty
                    services offered at very low cost, ensuring accessible and
             ...
             <div>
                 <img src="./Fostering/fos_img-11.png" alt="" />
             </div>
        </div>
        ...
        <div className='grid lg:grid-cols-2 sm:grid-cols-1 gap-8 mt-16 mb-16'>
             <div>
                ...
                <p className='text-3xl pt-16'>The second edition of the handbook provides guidance for homeowners,
                    ...
                    conservation. The goal is to encourage sustainable practices for buildings
                    up to G+3 levels on plots up to 500 sq.m, considering regional climates
             ...
             <div>
                ...
                <p className='text-3xl pt-16'>To rejuvenate traditional arts and empower communities, the project
                    ...
                    cultural heritage, and promote community development. Additionally,
                    leveraging social media for sustainable housing promotion further
