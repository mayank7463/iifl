  ...
  return (
    <div className='container-margin'>
            ...
            <div className='mt-16'>
                 <div className='grid lg:grid-cols-2 sm:grid-cols-1'>
                     <div>
                        ...
                        country. To enhance affordability and
                        accessibility of home loans, we have
                        implemented a streamlined process
                        with minimal documentation and
                        facilitate quick approvals within 30
                        minutes, our ‘Jhatpat’ solution. We
                        recognise the importance of supporting
                        first-time home buyers, particularly
                        those from the Economically Weaker
                        Section (EWS) and Lower Income
                        Groups (LIG). Therefore, we offer
                        competitive interest rates and flexible
                        repayment terms. By focusing on the
                        needs of the underserved, we are also
                        contributing to the nation’s vision
                        of financial inclusion and broader
        ...
        <div className='grid lg:grid-cols-2 sm:grid-cols-1'>
             <div>
                 ...
                 <p className='text-3xl pt-8'>Our Secured Business Loan offers
                    ...
                    assistance for funding business
                    expansion, launching new products and
                    augmenting existing infrastructure.
                    It provides access to larger loan
                    amounts, competitive interest rates
        ...
        <div className='grid lg:grid-cols-2 sm:grid-cols-1 mt-16 mb-16'>
             <div>
                 ...
                 <p className='text-3xl pt-8'>Shakthi Loan is a specialised Loan
                    ...
                    etc. providing them with quick and
                    easy access to funds for scaling up
                    day-to-day operations. The loans are
                    swiftly approved within 30-minutes
                    and enables people from underserved
                    and informal sections of society to
                    conveniently avail credit. It aims to
                    provide credit solutions to last-mile
                    micro businesses such as grocery
                    stores, vegetable vendors, small
                    traders, salons and other businesses
                    engaged in the unorganised sector.
                    With lower interest rates, flexible
                    loan repayment tenures, top-up
                    facility and simple documentation
                    processes, Shakthi Loans are
                    designed to offer the power of financial
                    inclusion to economically weaker
             ...
             <div className='flex flex-col justify-end'>
                <img src="./WeDo/wedo_img-3.svg" alt="" className='w-full'/>
             </div>
        </div>
        <div className='mt-16 mb-16'>
              <div>
                  ...
                  <div className='grid lg:grid-cols-2 sm:grid-cols-1 mt-16 gap-6 '>
                       ...
                       <div>
                            ...
                            at one place. It is an end-to-end
                            ...
                            digital and new age. Also, it is a place
              ...
              <img src="./WeDo/wedo_img-4.svg" alt="" />
        </div>
