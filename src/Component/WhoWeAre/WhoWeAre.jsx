    ...
    <div className='container-margin'>
            ...
            <div className='grid lg:grid-cols-2 sm:grid-cols-1 mt-16'>
                <div className='text-3xl  flex flex-col pt-8'>
                    ...
                    <h1 className='lg:text-5xl text-4xl font-bold text-[#1b328a] py-8'>Who We Serve</h1>
            ...
            <div className='grid lg:grid-cols-3 sm:grid-cols-1 mt-8 gap-4'>
                 <div className=''>
                    ...
                    <p className='text-3xl pt-4'>To be the most
                    respected financial
                    services company
                    in India. Not
                 ...
                 <div className=''>
                    ...
                    <p className='font-bold text-[#1b328a] text-4xl pt-4'>Vision</p>
                    <p className='text-3xl pt-4'>Enabling sustainable
                    housing through
                 ...
                 <div className=''>
                    ...
                    <p className='font-bold text-[#1b328a] text-4xl pt-4'>Core Values Guiding Our Path</p>
                    <p className='text-3xl pt-4'>Our core values serve as a moral
                    compass in all our activities. Fairness,
                    Integrity and Transparency - FIT is the
                    driving force behind all that we do.</p>
                 </div>
            </div>
            <div className='grid lg:grid-cols-3 sm:grid-cols-1 text-3xl mt-16 gap-4'>
                <div>
            ...
            <div className='mt-16'>
                 ...
                 <div className='grid lg:grid-cols-3 sm:grid-cols-1 gap-4 pt-16 pb-16'>
                    <div>
                        <p className='lg:text-5xl text-4xl text-[#f48172] font-bold'>₹35,498.55 <sub>Cr[$4.33Bn]</sub></p>
                        <p className='text-3xl pt-6'>Assets Under Management (AUM)</p>
                    </div>
                    <div>
                        <p className='lg:text-5xl text-4xl text-[#f48172] font-bold'>2,59,520+*</p>
                        <p className='text-3xl pt-6'>First Time Home Buyers</p>
                    </div>
                    <div>
                        <p className='lg:text-5xl text-4xl text-[#f48172] font-bold'>2,15,690+*</p>
                        <p className='text-3xl pt-6'>Women Borrowers/
                        Co-Borrowers</p>
                    </div>
                 </div>
                 <div className='grid lg:grid-cols-3 sm:grid-cols-1 gap-4 pt-16 pb-16'>
                    <div>
                        <p className='lg:text-5xl text-4xl text-[#f48172] font-bold'>₹14.26 <sub>Lakh[$ 0.017 Mn]</sub></p>
                        <p className='text-3xl pt-6'>Average Ticket Size</p>
                    </div>
                    <div>
                        <p className='lg:text-5xl text-4xl text-[#f48172] font-bold'>1,38,120+*</p>
                        <p className='text-3xl pt-6'>Loans to Informal Segment</p>
                    </div>
                    <div>
                        <p className='lg:text-5xl text-4xl text-[#f48172] font-bold'>5,250+**</p>
                        <p className='text-3xl pt-6'>Permanent Employees</p>
                    </div>
                 </div>
                 <div className='grid lg:grid-cols-3 sm:grid-cols-1 gap-4 pt-16 pb-16'>
                    <div>
                        <p className='lg:text-5xl text-4xl text-[#f48172] font-bold'>₹12,861 <sub>Cr[$ 1.57 Bn]</sub></p>
